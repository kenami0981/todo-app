...
@NgModule({ imports: [],
  	declarations: [],
  	providers: [FirebaseTodoAppService, { provide: GETS_ALL_LIST_DTO, useExisting: FirebaseTodoAppService }, { provide: ADDS_LIST_DTO, useExisting: FirebaseTodoAppService }, { provide: REMOVES_LIST_DTO, useExisting: FirebaseTodoAppService }],
  	exports: [] })
